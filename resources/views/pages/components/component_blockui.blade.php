            ...
            backgroundColor: 'transparent'
                ...
                <div id="blockUIAnimation" class="col-xl-12 col-sm-12 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area text-center">
                            <button class="mr-2 btn btn-primary" id="message-animation"
                                data-animation="fadeInDown">Message Animation</button>

                            <div class="blockui-animation-container">
                                <span class="text-semibold"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        class="feather feather-loader spin no-edge-top">
        ...
        $(this).removeClass("animated " + animation);
                ...
                <div id="blockUIModal" class="col-xl-12 col-sm-12 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area text-center">
                            <button class="mr-2 btn btn-primary message" data-toggle="modal"
                                data-target="#exampleModal">Modal</button>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" id="modal-reload">
                                                ...
                                                <div class="form-check pl-0">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="exampleCheck1">
                                                        <label class="custom-control-label" for="exampleCheck1">Check me
                                                            out</label>
                                                    </div>
                                                </div>
                                            </form>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button id="modal-blockui" type="button"
