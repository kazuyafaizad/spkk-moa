...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Afacad&family=Mulish:wght@400;900&display=swap" rel="stylesheet">
                            ...
                            <div class="form">
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input id="password" name="password" type="password" placeholder="Password"
                                        value="password" class="form-control @error('password') is-invalid @enderror"
