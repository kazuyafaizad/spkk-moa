    ...
    <AppLayout title="Discover More">
        ...
        <div class="w-full max-w-full mb-4 bg-transparent">
            <div class="my-4">
                ...
                <div
                    class="font-sans text-black bg-white flex items-center justify-center w-1/4"
                >
                    <div
            ...
            <div class="mt-8 grid lg:grid-cols-3 gap-10">
                <template v-for="(r, i) in $page.props.recipe.data" :key="i">
                    <Link :href="route('recipe.show', { recipe: r.id })">
                        <div
                            class="card hover:shadow-lg transform transition duration-500 z-10"
                        >
                            <img
                                :src="r.image"
                                alt="stew"
