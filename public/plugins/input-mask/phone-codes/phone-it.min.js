...
!(function (a) {
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof exports
      ? (module.exports = a(require('../inputmask')))
      : a(window.Inputmask)
})(function (a) {
  return (
    a.extendAliases({
      phoneit: {
        ...
        phoneCodes: [
          ...
          { mask: '+39 0122 ########', cc: 'IT', cd: 'Italy', reguib: 'Susa (TO)', city: 'Susa' },
          {
            mask: '+39 0123 ########',
            cc: 'IT',
            cd: 'Italy',
          ...
          { mask: '+39 0173 ########', cc: 'IT', cd: 'Italy', reguib: 'Alba (CN)', city: 'Alba' },
          {
            mask: '+39 0174 ########',
            cc: 'IT',
            cd: 'Italy',
          ...
          { mask: '+39 0183 ########', cc: 'IT', cd: 'Italy', reguib: 'Imperia', city: 'Imperia' },
          {
            mask: '+39 0184 ########',
            cc: 'IT',
            cd: 'Italy',
          ...
          { mask: '+39 0371 ########', cc: 'IT', cd: 'Italy', reguib: 'Lodi', city: 'Lodi' },
          {
            mask: '+39 0372 ########',
            cc: 'IT',
            cd: 'Italy',
          ...
          { mask: '+39 0373 ########', cc: 'IT', cd: 'Italy', reguib: 'Crema (CR)', city: 'Crema' },
          {
            mask: '+39 0374 ########',
            cc: 'IT',
            cd: 'Italy',
          ...
          { mask: '+39 040 ########', cc: 'IT', cd: 'Italy', reguib: 'Trieste', city: 'Trieste' },
          {
            mask: '+39 041 ########',
            cc: 'IT',
            cd: 'Italy',
          ...
          { mask: '+39 0463 ########', cc: 'IT', cd: 'Italy', reguib: 'Cles (TN)', city: 'Cles' },
          {
            mask: '+39 0464 ########',
            cc: 'IT',
            cd: 'Italy',
          ...
          { mask: '+39 0542 ########', cc: 'IT', cd: 'Italy', reguib: 'Imola (BO)', city: 'Imola' },
          { mask: '+39 0543 ########', cc: 'IT', cd: 'Italy', reguib: 'Forlì', city: 'Forlì' },
          {
            mask: '+39 0544 ########',
            cc: 'IT',
            cd: 'Italy',
          ...
          { mask: '+39 0573 ########', cc: 'IT', cd: 'Italy', reguib: 'Pistoia', city: 'Pistoia' },
          { mask: '+39 0574 ########', cc: 'IT', cd: 'Italy', reguib: 'Prato', city: 'Prato' },
          {
            mask: '+39 0575 ########',
            cc: 'IT',
            cd: 'Italy',
          ...
          { mask: '+39 0722 ########', cc: 'IT', cd: 'Italy', reguib: 'Urbino', city: 'Urbino' },
          { mask: '+39 0731 ########', cc: 'IT', cd: 'Italy', reguib: 'Jesi (AN)', city: 'Jesi' },
          {
            mask: '+39 0732 ########',
            cc: 'IT',
            cd: 'Italy',
          ...
          { mask: '+39 0982 ########', cc: 'IT', cd: 'Italy', reguib: 'Paola (CS)', city: 'Paola' },
          {
            mask: '+39 0983 ########',
            cc: 'IT',
            cd: 'Italy',
          ...
          { mask: '+39 3## #######', cc: 'IT', cd: 'Italy', reguib: 'Mobile', city: '' }
        ]
      }
    }),
    a
