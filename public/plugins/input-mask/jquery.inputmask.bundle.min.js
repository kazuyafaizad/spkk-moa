  ...
  function (e, t, n) {
    ...
    ;(o = function (e, t, n, i) {
      ...
      function c(t, n, a) {
        ...
        return r
          ? (r.alias && c(r.alias, i, a), e.extend(!0, a, r), e.extend(!0, a, n), !0)
      ...
      function p(t, n) {
        function a(t, a, r) {
          ...
          var l,
            c = o ? 'regex_' + r.regex : r.numericInput ? t.split('').reverse().join('') : t
          return (
      ...
      function m(a, c, p) {
            ...
            if (!0 === e && M().validPositions[f])
              (l = (u =
                ...
                M().validPositions[f + 1] !== i
                  ...
                  : D(f, N(f, s, f - 1))).match),
                (s = u.locator.slice()),
                c.push(!0 === n ? u.input : !1 === n ? l.nativeDef : $(f, l))
            else {
        ...
        function D(e, t, n) {
          for (
            var a,
              r = T((e = e > 0 ? e - 1 : 0), t),
              o = r.alternation !== i ? r.locator[r.alternation].toString().split(',') : [],
              s = 0;
            s < t.length &&
            (!(
              (a = t[s]).match &&
              ((p.greedy && !0 !== a.match.optionalQuantifier) ||
                ((!1 === a.match.optionality || !1 === a.match.newBlockMarker) &&
                  !0 !== a.match.optionalQuantifier)) &&
              (r.alternation === i ||
                r.alternation !== a.alternation ||
                (a.locator[r.alternation] !== i &&
                  L(a.locator[r.alternation].toString().split(','), o)))
            ) ||
              (!0 === n && (null !== a.match.fn || /[0-9a-bA-Z]/.test(a.match.def))));
            s++
          );
          return a
        }
        ...
        function N(t, n, a) {
          ...
          function g(n, a, o, s) {
            function l(o, s, u) {
              ...
              if (c === t && o.matches === i)
                return m.push({ match: o, locator: s.reverse(), cd: h, mloc: {} }), !0
              if (o.matches !== i) {
                if (o.isGroup && u !== o) {
                  ...
                  if (-1 === E || 'string' == typeof E) {
                    ...
                    else for (w = 0; w < P.matches.length; w++) _.push(w.toString())
                    if (M().excludes[t]) {
                    ...
                    ;(!0 === p.keepStatic ||
                      (isFinite(parseInt(p.keepStatic)) && O >= p.keepStatic)) &&
                      (_ = _.slice(0, 1))
                    for (var R = !1, N = 0; N < _.length; N++) {
                      ;(w = parseInt(_[N])),
                        (m = []),
                        (a = ('string' == typeof E && v(c, w, C)) || D.slice()),
                  ...
                  for (
                    ...
                    K < (isNaN(V.quantifier.max) ? K + 1 : V.quantifier.max) && c <= t;
                    K++
                  ) {
          ...
          if (t > -1) {
            if (n === i) {
              ...
              v !== i &&
                ...
                s.length > 0 &&
                  (s[0].alternation === i
                    ? 0 === (l = D(o, s.slice()).locator.slice()).length &&
                      (l = s[0].locator.slice())
          ...
          return (
            (0 === m.length || d) &&
              m.push({
                match: { fn: null, optionality: !0, casing: null, def: '', placeholder: '' },
                locator: [],
                mloc: {},
                cd: h
              }),
        ...
        function G() {
          return (
            M()._buffer === i &&
              ((M()._buffer = E(!1, 1)), M().buffer === i && (M().buffer = M()._buffer.slice())),
            M()._buffer
          )
        }
        function I(e) {
        ...
        function L(t, n, a) {
          for (
            var r, o = p.greedy ? n : n.slice(0, 1), s = !1, l = a !== i ? a.split(',') : [], u = 0;
            u < l.length;
            u++
          )
        ...
        function H(t, n, a, r, o) {
          var s,
            ...
            h = !1,
            g = o !== i ? o : O()
          if (-1 === g && o === i) l = (c = T((s = 0))).alternation
          else
            for (; g >= 0; g--)
          ...
          if (l !== i) {
            ...
            for (; M().excludes[m] && M().excludes[m].length < 10; ) {
              ...
              for (M().tests[m] = i, w(!0), h = !0; b.length > 0; ) {
                var x = b.shift()
                if (!(h = V(O(i, !0) + 1, x, !1, r, !0))) break
              }
              if (h && n !== i) {
                var P = O(t) + 1
                for (p = m; p < O() + 1; p++)
                  ((f = M().validPositions[p]) === i || null == f.match.fn) && p < t + y && y++
        ...
        function V(t, n, a, r, o, s) {
                            ...
                            input: (function (t, n, i) {
                              switch (p.casing || n.casing) {
                                ...
                                case 'title':
                                  ...
                                  t =
                                    0 === i ||
                                    (a && a.input === String.fromCharCode(u.keyCode.SPACE))
                                      ? t.toUpperCase()
                                      : t.toLowerCase()
                                  break
                                default:
          ...
          if (
            (e.isFunction(p.preValidation) &&
              ...
              !0 !== r &&
              !0 !== s &&
              (m = p.preValidation(I(), c, n, l(t), p, M())),
            !0 === m)
          ) {
            if (
              (K(i, c, !0),
              (g === i || c < g) && ((m = f(c, n, a)), (!a || !0 === r) && !1 === m && !0 !== s))
            ) {
          ...
          return (
            m && m.pos === i && (m.pos = c),
            (!1 !== m && !0 !== s) || (w(!0), (M().validPositions = e.extend(!0, {}, d))),
            m
          )
        }
        function K(t, n, a) {
        ...
        function U(t, n, a, r) {
          function o(e, t, n) {
            ...
            if (
              a !== i &&
              ((null === a.match.fn && !0 !== a.match.optionality) || a.input === p.radixPoint)
            ) {
              var r =
          ...
          if (
            ...
            var f = !0,
              ...
              g = m
            for (
              n && ((M().validPositions[r] = e.extend(!0, {}, n)), h++, m++, s < l && g++);
              g <= c;
              g++
            ) {
              var v = u[g]
              if (
                v !== i &&
                (g >= l || (g >= s && !0 !== v.generatedInput && o(g, u, { begin: s, end: l })))
              ) {
                for (; '' !== T(h).match.def; ) {
        ...
        function q(e, t) {
          for (
            var n = e + 1;
            '' !== T(n).match.def &&
            ((!0 === t && (!0 !== T(n).match.newBlockMarker || !z(n))) || (!0 !== t && !z(n)));
        ...
        function Q(e, t) {
          ...
          for (
            ...
            ((!0 === t && !0 !== T(i).match.newBlockMarker) ||
              (!0 !== t &&
                !z(i) &&
                ((n = N(i)).length < 2 || (2 === n.length && '' === n[1].match.def))));
        ...
        function W(t, n, a, r, o) {
          ...
          if (
            ...
            a === i || (r !== i && 'blur' === r.type) ? le(t, a, 0 === n.length) : ne(t, a),
            !0 === o)
          ) {
            var u = e(t),
          ...
          Y = {
            keydownEvent: function (t) {
              ...
              if (
                ...
                t.preventDefault(),
                  oe(n, a, r),
                  W(n, I(!0), M().p, t, n.inputmask._valueGet() !== I().join(''))
                ...
                (a === u.keyCode.HOME && !t.shiftKey) || a === u.keyCode.PAGE_UP
                  ? (t.preventDefault(), ne(n, 0, t.shiftKey ? r.begin : 0, !0))
                  : ((p.undoOnEscape && a === u.keyCode.ESCAPE) || (90 === a && t.ctrlKey)) &&
                      !0 !== t.altKey
                    ? (X(n, !0, !1, d.split('')), i.trigger('click'))
                    : a !== u.keyCode.INSERT || t.shiftKey || t.ctrlKey
                      ? !0 === p.tabThrough && a === u.keyCode.TAB
                        ? (!0 === t.shiftKey
                            ? (null === T(r.begin).match.fn && (r.begin = q(r.begin)),
                              (r.end = Q(r.begin, !0)),
                              (r.begin = Q(r.end, !0)))
                            : ((r.begin = q(r.begin, !0)),
                              (r.end = q(r.begin, !0)),
                              r.end < M().maskLength && r.end--),
                          r.begin < M().maskLength && (t.preventDefault(), ne(n, r.begin, r.end)))
                        : t.shiftKey ||
                          (!1 === p.insertMode &&
                            (a === u.keyCode.RIGHT
                              ? setTimeout(function () {
                      ...
                      : ((p.insertMode = !p.insertMode),
                        ne(n, p.insertMode || r.begin !== M().maskLength ? r.begin : r.begin - 1))
              p.onKeyDown.call(this, t, I(), ne(n).begin, p),
                (S = -1 !== e.inArray(a, p.ignorables))
            },
            keypressEvent: function (t, n, a, r, o) {
              var s = this,
                l = e(s),
                c = t.which || t.charCode || t.keyCode
              if (!(!0 === n || (t.ctrlKey && t.altKey)) && (t.ctrlKey || t.metaKey || S))
                return (
                  c === u.keyCode.ENTER &&
                    d !== I().join('') &&
                    ((d = I().join('')),
              ...
              if (c) {
                ...
                if (
                  (!1 !== k &&
                    (w(!0),
                    (f = k.caret !== i ? k.caret : q(k.pos.begin ? k.pos.begin : k.pos)),
                    (M().p = f)),
                  (f = (p.numericInput && k.caret === i ? Q(f) : f) + g),
                  !1 !== a &&
                    (setTimeout(function () {
            ...
            pasteEvent: function (n) {
              ...
              if (
                (l === (b ? G().reverse() : G()).slice(0, s.begin).join('') && (l = ''),
                u === (b ? G().reverse() : G()).slice(s.end).join('') && (u = ''),
                b && ((i = l), (l = u), (u = i)),
              ...
              return (
                X(a, !1, !1, b ? c.split('').reverse() : c.toString().split('')),
                W(a, I(), q(O()), n, d !== I().join('')),
                n.preventDefault()
              )
            },
              ...
              if (I().join('') !== r) {
                ...
                if (
                  ...
                  '.' === (n = r).charAt(i.begin - 1) &&
                    '' !== p.radixPoint &&
                    (((n = n.split(''))[i.begin - 1] = p.radixPoint.charAt(0)), (n = n.join(''))),
                  (r = (function (e, t, n) {
                    if (o) {
                  ...
                  if (f !== d) {
                    for (
                      var y = (k = f.length >= d.length) ? f.length : d.length, b = 0;
                  ...
                  if (
                    ...
                    W(a, I(), { begin: g.begin + c, end: g.end + c }),
                    v.length > 0)
                  )
                    ...
                    g.begin === g.end - 1 &&
                      ((g.begin = Q(g.begin + 1)),
                      g.begin === g.end - 1 ? ne(a, g.begin) : ne(a, g.begin, g.end))
                    var x = new e.Event('keydown')
                    ;(x.keyCode = p.numericInput ? u.keyCode.BACKSPACE : u.keyCode.DELETE),
                      Y.keydownEvent.call(a, x),
                      !1 === p.insertMode && ne(a, ne(a).begin - 1)
                  }
                  t.preventDefault()
                }
              }
            ...
            setValueEvent: function (t) {
              ...
              e.isFunction(p.onBeforeMask) && (n = p.onBeforeMask.call(k, n, p) || n),
                (n = n.split('')),
                X(this, !0, !1, b ? n.reverse() : n),
                (d = I().join('')),
                (p.clearMaskOnLostFocus || p.clearIncomplete) &&
                  this.inputmask._valueGet() === G().join('') &&
            ...
            focusEvent: function (e) {
              ...
              p.showMaskOnFocus &&
                ...
                (t.inputmask._valueGet() !== I().join('')
                  ? W(t, I(), q(O()))
                  : !1 === A && ne(t, q(O()))),
                !0 === p.positionCaretOnTab && !1 === A && Y.clickEvent.apply(t, [e, !0]),
                (d = I().join(''))
            },
            ...
            clickEvent: function (t, a) {
              ...
              setTimeout(function () {
                if (n.activeElement === r) {
                  var t = ne(r)
                  if ((a && (b ? (t.end = t.begin) : (t.begin = t.end)), t.begin === t.end))
                    switch (p.positionCaretOnClick) {
                      ...
                      default:
                        var s = t.begin,
                          l = O(s, !0),
                          u = q(l)
                        if (s < u) ne(r, z(s, !0) || z(s - 1, !0) ? s : q(s))
                        else {
                          var c = M().validPositions[l],
                            f = F(u, c ? c.match.locator : i, c),
                            m = $(u, f.match)
                          if (
                            ('' !== m &&
                              I()[u] !== m &&
                            ...
                            (!z(u, p.keepStatic) && f.match.def === m)
                          ) {
                            var d = q(u)
                            ;(s >= d || s === u) && (u = d)
                          }
            ...
            cutEvent: function (i) {
              ...
              o.setData('text', b ? s.reverse().join('') : s.join('')),
                n.execCommand && n.execCommand('copy'),
                oe(this, u.keyCode.DELETE, a),
                W(this, I(), M().p, i, d !== I().join(''))
            },
            blurEvent: function (t) {
              ...
              if (this.inputmask) {
                var a = this.inputmask._valueGet(),
                  r = I().slice()
                ;('' === a && v === i) ||
                  (p.clearMaskOnLostFocus && (-1 === O() && a === G().join('') ? (r = []) : ae(r)),
                  !1 === re(r) &&
                    (setTimeout(function () {
                      n.trigger('incomplete')
                    }, 0),
                    p.clearIncomplete && (w(), (r = p.clearMaskOnLostFocus ? [] : G().slice()))),
                  W(this, r, i, t)),
                  d !== I().join('') && ((d = r.join('')), n.trigger('change'))
              }
            },
            ...
            submitEvent: function (e) {
              d !== I().join('') && h.trigger('change'),
                p.clearMaskOnLostFocus &&
                  -1 === O() &&
                  y.inputmask._valueGet &&
                  y.inputmask._valueGet() === G().join('') &&
                  y.inputmask._valueSet(''),
                p.clearIncomplete && !1 === re(I()) && y.inputmask._valueSet(''),
        ...
        function X(t, n, a, r, o) {
          var s = r.slice(),
            ...
            c = -1,
            f = i
          if ((w(), a || !0 === p.autoUnmask)) c = q(c)
          else {
            var m = G().slice(0, q(-1)).join(''),
              d = s.join('').match(new RegExp('^' + u.escapeRegex(m), 'g'))
            d && d.length > 0 && (s.splice(0, d.length * m.length), (c = q(c)))
          }
          ;-1 === c ? ((M().p = q(c)), (c = 0)) : (M().p = c),
            e.each(s, function (n, r) {
              if (r !== i)
                if (
                  ...
                  var u = O(i, !0),
                    m = T(u),
                    d = F(u + 1, m ? m.locator.slice() : i, u)
                  if (
                    ((g = c),
                    (v = l),
                    -1 === E(!0, 0, !1).slice(g, q(g)).join('').indexOf(v) ||
                      z(g) ||
                      (T(g).match.nativeDef !== v.charAt(0) &&
                        (' ' !== T(g).match.nativeDef ||
                          T(g + 1).match.nativeDef !== v.charAt(0))) ||
                      a ||
                      p.autoUnmask)
                  ) {
                    var h = a
                      ? n
                      : null == d.match.fn && d.match.optionality && u + 1 < M().p
                        ? u + 1
                        : M().p
          ...
          if (r === i)
            return (
              a.setSelectionRange
                ...
                : t.getSelection
                  ? ((u = t.getSelection().getRangeAt(0)).commonAncestorContainer.parentNode !==
                      a &&
                  ...
                  : n.selection &&
                    ...
                    (o =
                      ...
                      u.text.length),
              { begin: s ? r : te(r), end: s ? o : te(o) }
            )
          if (
            (e.isArray(r) && ((o = b ? r[0] : r[1]), (r = b ? r[1] : r[0])),
            r.begin !== i && ((o = b ? r.begin : r.end), (r = b ? r.end : r.begin)),
            'number' == typeof r)
          ) {
              ...
              (p &&
                ((p !== l[n].locator[u.alternation] && null != a.match.fn) ||
                  (null === a.match.fn &&
                    ...
                    L(a.locator[u.alternation].toString().split(','), p.toString().split(',')) &&
                    '' !== N(n)[0].def)))) &&
            r[n] === $(n, a.match);
            n--
          )
        ...
        function oe(e, t, n, a, r) {
          ...
          if (
            (t === u.keyCode.BACKSPACE && (n.end - n.begin < 1 || !1 === p.insertMode)
              ? ((n.begin = Q(n.begin)),
            ...
            if (s) {
              var l =
                s.caret !== i ? s.caret : s.pos ? q(s.pos.begin ? s.pos.begin : s.pos) : O(-1, !0)
        ...
        function le(e, t, a) {
          ...
          if (v !== i) {
            ...
            if ((t === i ? (t = ne(e)) : t.begin === i && (t = { begin: t, end: t }), !0 !== a)) {
              ...
              do {
                M().validPositions[c]
                  ? ((o = M().validPositions[c]), (r = o.match), (s = o.locator.slice()), f(m[c]))
                  : ((o = F(c, s, c - 1)),
                    (r = o.match),
                    (s = o.locator.slice()),
                    !1 === p.jitMasking ||
                    c < d ||
                    ('number' == typeof p.jitMasking && isFinite(p.jitMasking) && p.jitMasking > c)
                      ? f($(c, r))
                      : (u = !1)),
                  c++
          ...
          switch (a.action) {
            ...
            case 'unmaskedvalue':
              return (
                (y !== i && a.value === i) ||
                  ((Z = a.value),
                  (Z = ((e.isFunction(p.onBeforeMask) && p.onBeforeMask.call(k, Z, p)) || Z).split(
                    ''
                  )),
                  X(i, !1, !1, b ? Z.reverse() : Z),
                  e.isFunction(p.onBeforeWrite) && p.onBeforeWrite.call(k, i, I(), 0, p)),
                ee(y)
              )
            case 'mask':
              !(function (t) {
                              ...
                              ? this.inputmask.opts.autoUnmask
                                ...
                                : -1 !== O() || !0 !== a.nullable
                                  ? n.activeElement === this && a.clearMaskOnLostFocus
                                    ? (b ? ae(I().slice()).reverse() : ae(I().slice())).join('')
                                    : r.call(this)
                                  : ''
                              : r.call(this)
                          }
                                    ...
                                    e.valHooks[t] = {
                                      get: function (e) {
                                        if (e.inputmask) {
                                          ...
                                          var t = n(e)
                                          return -1 !==
                                            O(i, i, e.inputmask.maskset.validPositions) ||
                                            !0 !== a.nullable
                                            ? t
                                            : ''
                                        }
                ...
                if (
                  !1 !== a &&
                  ((h = e((y = t))),
                  -1 === (g = y !== i ? y.maxLength : i) && (g = i),
                  !0 === p.colorMask && se(y),
                  r &&
                    ('inputmode' in y &&
                      ((y.inputmode = p.inputmode), y.setAttribute('inputmode', p.inputmode)),
                    !0 === p.disablePredictiveText &&
                      ('autocorrect' in y
                        ? (y.autocorrect = !1)
                        : (!0 !== p.colorMask && se(y), (y.type = 'password')))),
                  !0 === a &&
                    (J.on(y, 'submit', Y.submitEvent),
                    J.on(y, 'reset', Y.resetEvent),
                    J.on(y, 'blur', Y.blurEvent),
                    J.on(y, 'focus', Y.focusEvent),
                    !0 !== p.colorMask &&
                      (J.on(y, 'click', Y.clickEvent),
                      J.on(y, 'mouseleave', Y.mouseleaveEvent),
                      J.on(y, 'mouseenter', Y.mouseenterEvent)),
                    J.on(y, 'dblclick', Y.dblclickEvent),
                    J.on(y, 'paste', Y.pasteEvent),
                    J.on(y, 'dragdrop', Y.pasteEvent),
                    J.on(y, 'drop', Y.pasteEvent),
                    J.on(y, 'cut', Y.cutEvent),
                    J.on(y, 'complete', p.oncomplete),
                    J.on(y, 'incomplete', p.onincomplete),
                    J.on(y, 'cleared', p.oncleared),
                    r || !0 === p.inputEventOnly
                      ? y.removeAttribute('maxLength')
                      : (J.on(y, 'keydown', Y.keydownEvent), J.on(y, 'keypress', Y.keypressEvent)),
                    J.on(y, 'compositionstart', e.noop),
                    J.on(y, 'compositionupdate', e.noop),
                    J.on(y, 'compositionend', e.noop),
                    J.on(y, 'keyup', e.noop),
                    J.on(y, 'input', Y.inputFallBackEvent),
                    J.on(y, 'beforeinput', e.noop)),
                  J.on(y, 'setvalue', Y.setValueEvent),
                  (d = G().join('')),
                  ...
                  var o =
                    (e.isFunction(p.onBeforeMask) &&
                      p.onBeforeMask.call(k, y.inputmask._valueGet(!0), p)) ||
                    y.inputmask._valueGet(!0)
                  '' !== o && X(y, !0, !1, b ? o.split('').reverse() : o.split(''))
                  var l = I().slice()
                  ;(d = l.join('')),
                    !1 === re(l) && p.clearIncomplete && w(),
                    p.clearMaskOnLostFocus &&
                      n.activeElement !== y &&
                      (-1 === O() ? (l = []) : ae(l)),
                    (!1 === p.clearMaskOnLostFocus ||
                      (p.showMaskOnFocus && n.activeElement === y) ||
                      '' !== y.inputmask._valueGet(!0)) &&
                      W(y, l),
                    n.activeElement === y && ne(y, q(O()))
                }
              })(y)
              break
            case 'format':
              return (
                (Z = (
                  (e.isFunction(p.onBeforeMask) && p.onBeforeMask.call(k, a.value, p)) ||
                  a.value
                ).split('')),
                X(i, !0, !1, b ? Z.reverse() : Z),
                a.metadata
                  ? {
            ...
            case 'isValid':
              a.value
                ? ((Z = a.value.split('')), X(i, !0, !0, b ? Z.reverse() : Z))
                : (a.value = I().join(''))
            ...
            case 'remove':
              if (y && y.inputmask)
                e.data(y, '_inputmask_opts', null),
                  (h = e(y)),
                  y.inputmask._valueSet(p.autoUnmask ? ee(y) : y.inputmask._valueGet(!0)),
                  J.off(y),
                  y.inputmask.colorMask &&
                    ((v = y.inputmask.colorMask).removeChild(y),
        ...
        (u.prototype = {
            ...
            return (
              ...
              e.each(a, function (n, a) {
                ...
                if (
                  (function (n, a, r, o) {
                    if (!0 === a.importDataAttributes) {
                      var s,
                        ...
                        p,
                        f = function (e, a) {
                          null !== (a = a !== i ? a : n.getAttribute(o + '-' + e)) &&
                            ('string' == typeof a &&
                              (0 === e.indexOf('on')
                                ? (a = t[a])
                                : 'false' === a
                  ...
                  s !== i &&
                    (a.inputmask !== i &&
                      ((a.inputmask.opts.autoUnmask = !0), a.inputmask.remove()),
          ...
          analyseMask: function (t, n, a) {
            ...
            function y(t, r, o) {
              ...
              var s = t.matches[o - 1]
              if (n)
                0 === r.indexOf('[') || (d && /\\d|\\s|\\w]/i.test(r)) || '.' === r
              ...
              if (d) b()
                ...
                switch (o.charAt(0)) {
                  ...
                  case a.quantifiermarker[0]:
                    ...
                    ;('*' !== M && '+' !== M) || (E = '*' === M ? 0 : 1),
                      (S.quantifier = { min: E, max: M, jit: A[1] })
                        ...
                        : (t.matches[n] =
                            ((s = t.matches[n]) === a.optionalmarker[0]
                              ...
                              : s === a.optionalmarker[1]
                                ...
                                : s === a.groupmarker[0]
                                  ? (s = a.groupmarker[1])
                                  : s === a.groupmarker[1] && (s = a.groupmarker[0]),
                            s))
                    }
                  var s
                  return t
      ...
      function s(e, t, i) {
                ...
                ((o =
                  4 === (a = t).length
                    ...
                    : new Date()
                        .getFullYear()
                        .toString()
                        .substr(0, 4 - a.length) + a),
                i.min && i.min.year && i.max && i.max.year
                  ? ((o = o.replace(/[^0-9]/g, '')),
                    (o +=
                      i.min.year == i.max.year
                        ? i.min.year.substr(o.length)
                        : ('' !== o && 0 == i.max.year.indexOf(o)
        ...
        if ('string' == typeof u) {
          for (; (o = a(i).exec(t)); ) {
            ...
            n.hasOwnProperty(o[0]) && ((r = n[o[0]][2]), (s = n[o[0]][1]), c(l, p, i)),
              (u = u.slice(p.length))
          }
          return l
        }
              ...
              return (
                u &&
                  ...
                  (u =
                    (u =
                      (!isFinite(o.day) ||
                        ('29' == o.day && !isFinite(o.rawyear)) ||
                        new Date(
                          o.date.getFullYear(),
                          isFinite(o.month) ? o.month : o.date.getMonth() + 1,
                          0
                        ).getDate() >= o.day) &&
                      l) &&
                    ((i = c),
                    ...
                    (a = n).min &&
                      ...
                      (r = a.min.date.getTime() <= i.date.getTime()),
                    r &&
                      a.max &&
                      a.max.date.getTime() == a.max.date.getTime() &&
                      (r = a.max.date.getTime() >= i.date.getTime()),
                    r))),
                u
              )
            },
                  ...
                  'd' === l[0].charAt(0)
                    ...
                    : 'm' === l[0].charAt(0)
                      ...
                      : 'yyyy' === l[0]
                        ...
                        : 'y' === l[0].charAt(0) && (c += o(u.getYear(), l[0].length))
          ...
          numeric: {
                    ...
                    if (
                      ((l = o).parseMinMaxOptions === n &&
                        (null !== l.min &&
                          ((l.min = l.min
                            .toString()
                            .replace(new RegExp(t.escapeRegex(l.groupSeparator), 'g'), '')),
            ...
            onBeforeMask: function (e, i) {
              if (
                ...
                2 === a.length &&
                  (a[0].length > r || a[1].length > r || (a[0].length <= r && a[1].length < r)) &&
                    ...
                    e.isArray(n[o])
                      ? 1 === n[o].length
                        ...
                        : r.push(
                            o +
                              a.groupmarker[0] +
                              n[o].join(a.groupmarker[1] + a.alternatormarker + a.groupmarker[0]) +
                              a.groupmarker[1]
                          )
                      : r.push(o + t(n[o]))
                  return (
                    1 === r.length
                      ...
                      : (i +=
                          a.groupmarker[0] +
                          r.join(a.groupmarker[1] + a.alternatormarker + a.groupmarker[0]) +
                          a.groupmarker[1]),
                    i
                  )
                })(r))),
