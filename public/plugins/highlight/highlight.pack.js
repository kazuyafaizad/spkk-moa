...
!(function (e) {
    ...
    function r(e, n) {
      ...
      if (r) {
        ...
        for (
          ...
          l.cN && (E += b), l.skip || l.sL || (R += l.r), (l = l.parent) !== r.parent;

        );
        return (
          r.starts && (r.endSameAsBegin && (r.starts.eR = r.eR), u(r.starts)), a.rE ? 0 : n.length
        )
      }
      if (
        (function (e, n) {
  ...
  function o(e) {
    ...
    l(o) ||
      (h.useBR
        ? ((n = document.createElementNS('http://www.w3.org/1999/xhtml', 'div')).innerHTML =
            e.innerHTML.replace(/\n/g, '').replace(/<br[ \/]*>/g, '\n'))
        : (n = e),
      (i = n.textContent),
      (r = o ? C(o, i, !0) : O(i)),
        ...
        (r.value = (function (e, n, t) {
          ...
          for (; e.length || n.length; ) {
            ...
            if (((a += _(t.substring(r, l[0].offset))), (r = l[0].offset), l === e)) {
              for (
                i.reverse().forEach(u);
                s(l.splice(0, 1)[0]), (l = o()) === e && l.length && l[0].offset === r;
  ...
  return (
    ...
    (a.C = a.COMMENT =
      function (e, n, t) {
        ...
        return (
          r.c.push(a.PWM), r.c.push({ cN: 'doctag', b: '(?:TODO|FIXME|NOTE|BUG|XXX):', r: 0 }), r
        )
      }),
        ...
        c: [
          ...
          e.RM,
          {
            ...
            c: [
              {
                cN: 'params',
                v: [{ b: r }, { b: /\(\s*\)/ }, { b: /\(/, e: /\)/, eB: !0, eE: !0, k: t, c: i }]
              }
            ]
          },
          { cN: '', b: /\s/, e: /\s*/, skip: !0 },
