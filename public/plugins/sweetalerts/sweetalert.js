...
;(function (global, factory) {
  ...
  var getFocusableElements = function getFocusableElements(focusCancel) {
    ...
    var focusableElements = buttons.concat(
  ...
  var setParameters = function setParameters(params) {
    ...
    var successIconParts = modal.querySelectorAll(
      ...
      if (params.animation) {
        switch (params.type) {
          case 'success':
            ...
            addClass(
              icon.querySelector('.swal2-success-line-tip'),
              'swal2-animate-success-line-tip'
            )
            addClass(
              icon.querySelector('.swal2-success-line-long'),
  ...
  var sweetAlert = function sweetAlert() {
    ...
    return new Promise(function (resolve, reject) {
      ...
      var onButtonEvent = function onButtonEvent(event) {
        ...
        var cancelButton = getCancelButton()
        var targetedConfirm =
          confirmButton && (confirmButton === target || confirmButton.contains(target))
        var targetedCancel =
          cancelButton && (cancelButton === target || cancelButton.contains(target))
      ...
      sweetAlert.recalculateHeight = debounce(
        function () {
          var modal = getModal()
          if (!modal) {
            return
  ...
  sweetAlert.setDefaults = function (userParams) {
    if (
      !userParams ||
      (typeof userParams === 'undefined' ? 'undefined' : _typeof(userParams)) !== 'object'
    ) {
