...
!(function (t) {
  ...
  ;(l.prototype.getMargin = function (t) {
    ...
    if (e && (t / e) % 1 != 0)
      throw new Error(
        'noUiSlider (' + lt + "): 'limit', 'margin' and 'padding' must be divisible by step."
      )
  ...
  function y(t, e) {
    ...
    if (0 !== e && ((t.margin = t.spectrum.getMargin(e)), !t.margin))
      throw new Error(
        'noUiSlider (' + lt + "): 'margin' option is only supported on linear sliders."
      )
  }
  function E(t, e) {
  ...
  function C(t, e) {
    ...
    if (0 !== e) {
      if (
        ...
        !(t.padding = [t.spectrum.getMargin(e[0]), t.spectrum.getMargin(e[1])]) === t.padding[0] ||
          !1 === t.padding[1])
      )
        throw new Error(
          'noUiSlider (' + lt + "): 'padding' option is only supported on linear sliders."
        )
  ...
  function z(t, f, o) {
          ...
          v.forEach(function (t, e) {
            ...
            if ((h && (r = E.xNumSteps[e]), r || (r = d - f), !1 !== f && void 0 !== d))
              for (r = Math.max(r, 1e-7), n = f; n <= d; n = (n + r).toFixed(7) / 1) {
                for (
                  u = (a = (o = E.toStepping(n)) - w) / m, p = a / (c = Math.round(u)), i = 1;
                  i <= c;
                  i += 1
                )
          ...
          return (
            ...
            !(
              (e.classList
                ...
                : new RegExp('\\b' + r + '\\b').test(e.className)) && !a.doNotReject
            ) &&
    ...
    function I(t, e) {
      ...
      1 === e.handleNumbers.length &&
        ((r = u[e.handleNumbers[0]].children[0]), (b += 1), ht(r, f.cssClasses.active))
      t.stopPropagation()
      var n = [],
        i = B(d.move, w, Y, {
          target: t.target,
