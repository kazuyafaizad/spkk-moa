  ...
  var calendar = $('#calendar').fullCalendar({
    ...
    events: [
      ...
      },
      {
        ...
        className: 'bg-warning',
        description:
          'Morbi odio lectus, porttitor molestie scelerisque blandit, hendrerit sed ex. Aenean malesuada iaculis erat, vitae blandit nisl accumsan ut.'
      },
      {
        id: 'event-8',
        title: 'Dinner',
    ...
    eventClick: function (info) {
      ...
      var taskInputStarttDateValue = taskInputStarttDate.val(
        info.start.format('YYYY-MM-DD HH:mm:ss')
      )
