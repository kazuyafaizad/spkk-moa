...
!(function (t) {
  ...
  function X(t, e) {
    return (
      ((t.start && e.start && t.start.isSame(e.start)) || (!t.start && !e.start)) &&
  ...
  function Wt(e, n) {
    ...
    function r() {
      ...
      ;(p = e.opt('theme') ? 'ui' : 'fc'),
        i
          ? (g ? g.empty() : (g = this.el = t("<div class='fc-toolbar " + n.extraClasses + "'/>")),
            g
              .append(o('left'))
              .append(o('right'))
              .append(o('center'))
            ...
            t.each(this.split(','), function (n, i) {
                    ...
                    (w = t('<button type="button" class="' + y.join(' ') + '">' + m + '</button>')
                      .click(function (t) {
                        w.hasClass(p + '-state-disabled') ||
                          (h(t),
                          (w.hasClass(p + '-state-active') || w.hasClass(p + '-state-disabled')) &&
              ...
              l &&
                s
                  ...
                  .end(),
              s.length > 1
                ? ((i = t('<div/>')), l && i.addClass('fc-button-group'), i.append(s), r.append(i))
                : r.append(s)
          }),
        r
      )
  ...
  function Ut() {
    ...
    function T(t) {
      return (
        ('object' == typeof t ? t.origArray || t.googleCalendarId || t.url || t.events : null) || t
      )
    }
    function C(e, n) {
    ...
    var U,
      ...
      K = []
    t.each(
      (q.opt('events') ? [q.opt('events')] : []).concat(q.opt('eventSources') || []),
      function (t, e) {
        var n = p(e)
        n && Q.push(n)
      }
      ...
      (q.rezoneArrayEventSources = function () {
        ...
        for (e = 0; e < Q.length; e++)
          if (((n = Q[e].events), t.isArray(n))) for (i = 0; i < n.length; i++) N(n[i])
      }),
    ...
    return (
      this.each(function (r, s) {
        ...
        'string' == typeof e
          ? l &&
            t.isFunction(l[e]) &&
            ((o = l[e].apply(l, n)), r || (i = o), 'destroy' === e && a.removeData('fullCalendar'))
  ...
  var de = ce.extend({
    ...
    queue: function (t, e, n) {
      ...
      e && (i = this.waitsByNamespace[e]),
        ...
        this.compoundTask(r) &&
          (this.waitNamespace || null == i ? this.tryStart() : this.startWait(e, i))
    },
      ...
      if (t.namespace && ('destroy' === t.type || 'init' === t.type)) {
        ...
        'destroy' === t.type
          ? i.length &&
            ((n = i[i.length - 1]),
            n.namespace === t.namespace &&
              ('init' === n.type ? ((r = !1), i.pop()) : 'destroy' === n.type && (r = !1)))
          : 'init' === t.type &&
            i.length &&
            ((n = i[i.length - 1]), n.namespace === t.namespace && 'init' === n.type && i.pop())
      }
      return r && i.push(t), r
    }
  })
  ...
  var ye = me.extend({
    ...
    handleDrag: function (t, e, n) {
      ...
      me.prototype.handleDrag.apply(this, arguments),
        ...
        Ht(i, this.hit) || (this.hit && this.handleHitOut(), i && this.handleHitOver(i))
    },
  ...
  var Se = bt.extend(ge, {
      ...
      stop: function (e, n) {
        ...
        this.isFollowing &&
          ...
          e && s && !this.isHidden
            ? ((this.isAnimating = !0),
              this.el.animate({ top: this.top0, left: this.left0 }, { duration: s, complete: i }))
            : i())
      },
      getEl: function () {
        var t = this.el
    ...
    be = (Zt.Grid = bt.extend(ge, {
      ...
      processRangeOptions: function () {
        ...
        ;(this.eventTimeFormat =
          n.opt('eventTimeFormat') || n.opt('timeFormat') || this.computeEventTimeFormat()),
      ...
      dayMousedown: function (t) {
        ...
        we.get().shouldIgnoreMouse() ||
          ...
          e.opt('selectable') &&
            this.daySelectListener.startInteraction(t, { distance: e.opt('selectMinDistance') }))
      },
      dayTouchStart: function (t) {
        ...
        n.isSelected ||
          ...
          this.dayClickListener.startInteraction(t),
          n.opt('selectable') && this.daySelectListener.startInteraction(t, { delay: e }))
      },
        ...
        return (
          Z(t, i.activeRange)
            ? (r.push('fc-' + Kt[t.day()]),
              ...
              (n = i.calendar.getNow()),
              t.isSame(n, 'day')
                ? (r.push('fc-today'), !0 !== e && r.push(i.highlightStateClass))
                : t < n
                  ? r.push('fc-past')
                  : r.push('fc-future'))
  ...
  be.mixin({
    ...
    startSegResize: function (e, n, i) {
      return (
        ...
        (this.buildSegResizeListener(e, t(n.target).is('.fc-start-resizer')).startInteraction(n, i),
        !0)
      )
    },
      ...
      var h = (this.segDragListener = new ye(a, {
        ...
        hitOver: function (e, o, l) {
          ...
          t.hit && (l = t.hit),
            ...
            c && d
              ? ((i = r.computeEventDrop(c, d, u)), (g = i && r.isEventLocationAllowed(i, u)))
              : (g = !1),
            g || ((i = null), s()),
            i && (f = a.renderDrag(i, t))
              ? (f.addClass('fc-dragging'), h.isTouch || r.applyDragOpacity(f), n.hide())
              : n.show(),
            o && (i = null)
        },
        hitOut: function () {
      ...
      return (
        o.hasTime() === a.hasTime()
          ? ((i = this.diffDates(a, o)),
            n.allDay && tt(i)
              ? ((r = { start: n.start.clone(), end: s.getEventEnd(n), allDay: !1 }),
    ...
    buildSegResizeListener: function (t, e) {
      ...
      return (this.segResizeListener = new ye(this, {
        ...
        hitOver: function (n, o, l) {
          ...
          d && f
            ? ((i = e ? r.computeEventStartResize(d, f, h) : r.computeEventEndResize(d, f, h)),
      ...
      return (
        ...
        r.start.isBefore(r.end) ||
          ((s =
            ...
            (i.allDay ? o.defaultAllDayEventDuration : o.defaultTimedEventDuration)),
    ...
    getSegDefaultBorderColor: function (t) {
      var e = t.event.source || {}
      return (
        e.borderColor || e.color || this.view.opt('eventBorderColor') || this.view.opt('eventColor')
      )
    },
    ...
    eventToRawRange: function (t) {
      ...
      return {
        start: t.start.clone().stripZone(),
          ...
          ? t.end.clone()
          : e.getDefaultEventEnd(null != t.allDay ? t.allDay : !t.start.hasTime(), t.start)
        ).stripZone()
      }
    },
  ...
  var Ee = (Zt.DayTableMixin = {
      ...
      updateDayTable: function () {
        for (
          var t, e, n, i = this.view, r = this.start.clone(), s = -1, o = [], a = [];
          r.isBefore(this.end);

        )
          i.isHiddenDay(r) ? o.push(s + 0.5) : (s++, o.push(s), a.push(r.clone())), r.add(1, 'days')
      ...
      limitRow: function (e, n) {
        ...
        if (n && n < S.segLevels.length) {
          for (
            ...
            if (h) {
              for (
                d = s[n - 1][l.leftCol], f = d.attr('rowspan') || 1, g = [], p = 0;
                p < c.length;
                p++
              )
  ...
  var Te = (Zt.TimeGrid = be.extend(Ee, {
    ...
    renderSlatRowHtml: function () {
      for (
        var t, n, i, r = this.view, s = this.isRTL, o = '', a = e.duration(+this.view.minTime);
        a < this.view.maxTime;
    ...
    sliceRangeByTimes: function (t) {
      ...
      for (n = 0; n < this.daysPerRow; n++)
        (i = this.dayDates[n].clone().time(0)),
          (r = { start: i.clone().add(this.view.minTime), end: i.clone().add(this.view.maxTime) }),
  ...
  var Ce = (Zt.View = ue.extend({
    ...
    computeTitle: function () {
      ...
      return (
        ...
        this.formatRange(
          { start: this.calendar.applyTimezone(t.start), end: this.calendar.applyTimezone(t.end) },
    ...
    buildGotoAnchorHtml: function (e, n, i) {
      ...
      return (
        ...
        (i = i || ''),
        !o && this.opt('navLinks')
          ? '<a' + n + ' data-goto="' + ht(JSON.stringify(a)) + '">' + i + '</a>'
          : '<span' + n + '>' + i + '</span>'
      )
    },
    setElement: function (t) {
    ...
    reportExternalDrop: function (e, n, i, r, s) {
      var o,
        a,
        l = e.eventProps
      l && ((o = t.extend({}, l, n)), (a = this.calendar.renderEvent(o, e.stick)[0])),
    ...
    processRangeUnselect: function (e) {
      ...
      this.isSelected &&
        ...
        (((n = this.opt('unselectCancel')) && t(e.target).closest(n).length) || this.unselect(e))
    },
    ...
    Ce.mixin({
      ...
      normalizeCurrentRange: function (t, e) {
        ;/^(year|month|week|day)$/.test(e)
          ...
          : (t.start.hasTime() || t.start.time(0), t.end.hasTime() || t.end.time(0))
      },
      adjustActiveRange: function (t, e, n) {
        ...
        this.usesMinMaxTime &&
          ...
          i && (t.start.hasTime() || t.start.time(0), t.end.hasTime() || t.end.time(0)))
      },
      ...
      getRangeOption: function (t) {
        var e = this.opt(t)
        if (
          ('function' == typeof e && (e = e.apply(null, Array.prototype.slice.call(arguments, 1))),
          e)
        )
  ...
  Re.mixin({
    ...
    setOptions: function (t) {
      ...
      if (1 === n) {
        ...
        if ('businessHours' === e)
          return void (
            this.view && (this.view.unrenderBusinessHours(), this.view.renderBusinessHours())
          )
    ...
    Re.mixin({
      ...
      buildViewSpec: function (t) {
        for (var i, r, s, o, a, l = this.overrides.views || {}, u = [], h = [], c = [], d = t; d; )
          (i = $t[d]),
            ...
            i &&
              (u.unshift(i), h.unshift(i.defaults || {}), (s = s || i.duration), (d = d || i.type)),
      ...
      buildViewSpecButtonText: function (t, e) {
        ...
        ;(t.buttonTextOverride =
          n(this.dynamicOverrides) || n(this.overrides) || t.overrides.buttonText),
          (t.buttonTextDefault =
      ...
      destroy: function () {
        this.view && this.view.removeElement(),
          ...
          this.windowResizeProxy &&
            (t(window).unbind('resize', this.windowResizeProxy), (this.windowResizeProxy = null)),
          we.unneeded()
      },
        ...
        i && (this.freezeContentHeight(), this.clearView()),
          !this.view &&
            ...
            this.view.setElement(
              t("<div class='fc-view fc-" + e + "-view' />").appendTo(this.contentEl)
            ),
  ...
  ;(Re.prototype.mutateSeg = function (t, e) {
    ...
    (Re.prototype.isSelectionSpanAllowed = function (t) {
      ...
      return (
        this.isSpanAllowed(t, this.opt('selectConstraint'), this.opt('selectOverlap')) &&
        (!e || !1 !== e(t))
      )
    }),
      ...
      for (r = 0; r < n.length; r++)
        (s = n[r]),
          (i && !s.dow) ||
            ...
            a.push.apply(
              a,
              this.expandEvent(this.buildEventFromInput(s), o.activeRange.start, o.activeRange.end)
            ))
      return a
    })
  var ze = (Zt.BasicView = Ce.extend({
      ...
      buildRenderRange: function (t, e) {
        ...
        return (
          /^(year|month)$/.test(e) &&
            (n.start.startOf('week'), n.end.weekday() && n.end.add(1, 'week').startOf('week')),
      ...
      renderDates: function () {
        ;(this.dayGrid.breakOnWeeks = /year|month|week/.test(this.currentRangeUnit)),
          ...
          (this.dayGrid.numbersVisible =
            this.dayNumbersVisible || this.cellWeekNumbersVisible || this.colWeekNumbersVisible),
    ...
    Ae = (Zt.MonthView = ze.extend({
      buildRenderRange: function () {
        ...
        return (
          this.isFixedWeeks() &&
            ((t = Math.ceil(e.end.diff(e.start, 'weeks', !0))), e.end.add(6 - t, 'weeks')),
          e
        )
      },
      setGridHeight: function (t, e) {
  ...
  var We = Ce.extend({
    ...
    Ye = be.extend({
      ...
      spanToSegs: function (t) {
        for (
          var e, n = this.view, i = n.renderRange.start.clone().time(0), r = 0, s = [];
          i < n.renderRange.end;
      ...
      handleSegClick: function (e, n) {
        ...
        be.prototype.handleSegClick.apply(this, arguments),
          t(n.target).closest('a[href]').length ||
            ((i = e.event.url) && !n.isDefaultPrevented() && (window.location.href = i))
      },
      renderFgSegs: function (t) {
        return (
      ...
      renderSegList: function (e) {
        ...
        for (n = 0; n < s.length; n++)
          if ((i = s[n]))
            for (
              a.append(this.dayHeaderHtml(this.view.renderRange.start.clone().add(n, 'days'))),
        ...
        return (
          ...
          '<tr class="' +
            ...
            (this.displayEventTime
              ? '<td class="fc-list-item-time ' + n.widgetContentClass + '">' + (e || '') + '</td>'
              : '') +
