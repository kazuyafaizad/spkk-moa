            ...
            (k.prototype = {
              ...
              abrupt: function (A, e) {
                ...
                return (
                  (B.type = A),
                  (B.arg = e),
                  i ? ((this.method = 'next'), (this.next = i.finallyLoc), s) : this.complete(B)
                )
              },
  ...
  return (
    Element.prototype.matches ||
      (Element.prototype.matches =
        ...
        function (A) {
          for (
            var e = (this.document || this.ownerDocument).querySelectorAll(A), t = e.length;
            --t >= 0 && e.item(t) !== this;
    ...
    (function () {
      function A(e, t) {
        ...
        if (
          ...
          (this.options.text.chooseFile = this.options.text.hasOwnProperty('chooseFile')
            ? this.options.text.chooseFile
            : 'Choose file...'),
          (this.options.text.browse = this.options.text.hasOwnProperty('browse')
            ? this.options.text.browse
            : 'Browse'),
          (this.options.text.selectedCount = this.options.text.hasOwnProperty('selectedCount')
          ...
          throw new Error(
            "Could not find a 'custom-file-container' with the id of: ".concat(this.uploadId)
          )
        if (
        ...
        ;(this.options.images = this.options.hasOwnProperty('images') ? this.options.images : {}),
          ...
          (this.backgroundImage = this.options.images.hasOwnProperty('backgroundImage')
