  ...
  function y(f, g) {
    ...
    function k() {
      if (void 0 !== h.hourElement && void 0 !== h.minuteElement) {
        ...
        void 0 !== h.amPM &&
          ((e = n), (t = h.amPM.textContent), (n = (e % 12) + 12 * o(t === h.l10n.amPM[1])))
        var r =
    ...
    function ge(e, t) {
      if (void 0 !== h.config) {
        ...
        'onChange' === e &&
          (h.input.dispatchEvent(pe('change')), h.input.dispatchEvent(pe('input')))
      }
    }
    function pe(e) {
      ...
      (function () {
        ;(h.element = h.input = f),
          ...
          (function () {
            ...
            i.altInputClass ||
              (h.config.altInputClass = h.input.className + ' ' + h.config.altInputClass),
                    ...
                    Object.defineProperty(h, '_hidePrevMonthArrow', {
                      ...
                      set: function (e) {
                        h.__hidePrevMonthArrow !== e &&
                          (c(h.prevMonthNav, 'flatpickr-disabled', e), (h.__hidePrevMonthArrow = e))
                      }
                    }),
                    Object.defineProperty(h, '_hideNextMonthArrow', {
                      ...
                      set: function (e) {
                        h.__hideNextMonthArrow !== e &&
                          (c(h.nextMonthNav, 'flatpickr-disabled', e), (h.__hideNextMonthArrow = e))
                      }
                    }),
