  ...
  ;(function (g) {
    ...
    k.DEFAULTS = {
      ...
      maxOptionsText: function (n, o) {
        return [
          n == 1 ? 'Limit reached ({n} item max)' : 'Limit reached ({n} items max)',
          o == 1 ? 'Group limit reached ({n} item max)' : 'Group limit reached ({n} items max)'
        ]
      },
    ...
    k.prototype = {
      ...
      createDropdown: function () {
        ...
        var p =
          ...
          u +
          ' role="button"><span class="filter-option float-left"></span>&nbsp;<span class="bs-caret">' +
          this.options.template.caret +
          '</span></button><div class="dropdown-menu select-dropdown open" role="combobox">' +
          t +
          r +
          q +
      ...
      createLi: function () {
        ...
        var p = function (B, z, A, y) {
          ...
          return (
            '<a tabindex="0"' +
            (typeof A !== 'undefined' && '' !== A ? ' class="' + A + '"' : '') +
            (typeof z !== 'undefined' && null !== z ? ' data-original-index="' + z + '"' : '') +
            (typeof y !== 'undefined' && null !== y ? 'data-optgroup="' + y + '"' : '') +
            '>' +
            B +
            '</a>'
          )
        ...
        var v = function (B, y, A, z) {
          ...
          return (
            '<span' +
            (typeof y !== 'undefined' ? ' class="' + y + '"' : '') +
            (A ? ' style="' + A + '"' : '') +
            (u.options.liveSearchNormalize
              ? ' data-normalized-text="' + c(l(g(B).html())) + '"'
              : '') +
            (typeof z !== 'undefined' || z !== null ? ' data-tokens="' + z + '"' : '') +
            ' role="option">' +
            B +
            '<span class="' +
            u.options.iconBase +
        ...
        o.each(function (C) {
          ...
          var E = this.className || '',
            ...
            R =
              typeof B.data('subtext') !== 'undefined'
                ? '<small class="text-muted">' + B.data('subtext') + '</small>'
                : '',
            O =
              typeof B.data('icon') !== 'undefined'
                ? '<span class="' + u.options.iconBase + ' ' + B.data('icon') + '"></span> '
                : '',
            J = B.parent(),
          ...
          if (z && B.data('divider') !== true) {
            ...
            if (B.index() === 0) {
              ...
              var D = J[0].label,
                Q =
                  typeof J.data('subtext') !== 'undefined'
                    ? '<small class="text-muted">' + J.data('subtext') + '</small>'
                    : '',
                K = J.data('icon')
                  ? '<span class="' + u.options.iconBase + ' ' + J.data('icon') + '"></span> '
                  : ''
            ...
            if (B.data('divider') === true) {
              ...
              if (B.data('hidden') === true) {
                ...
                var I =
                  this.previousElementSibling && this.previousElementSibling.tagName === 'OPTGROUP'
      ...
      render: function (r) {
        ...
        var p = o
          .map(function () {
            if (this.selected) {
              if (
                q.options.hideDisabled &&
                (this.disabled ||
                  (this.parentNode.tagName === 'OPTGROUP' && this.parentNode.disabled))
              ) {
                return
              }
              var y = g(this),
                x =
                  y.data('icon') && q.options.showIcon
                    ? '<i class="' + q.options.iconBase + ' ' + y.data('icon') + '"></i> '
                    : '',
                w
            ...
            var u = o.not('[data-divider="true"], [data-hidden="true"]' + n).length,
              v =
                typeof this.options.countSelectedText === 'function'
                  ? this.options.countSelectedText(p.length, u)
      ...
      liHeight: function (t) {
        ...
        var p = J.offsetHeight,
          ...
          G = {
            vert:
              parseInt(o ? o.paddingTop : u.css('paddingTop')) +
              parseInt(o ? o.paddingBottom : u.css('paddingBottom')) +
              parseInt(o ? o.borderTopWidth : u.css('borderTopWidth')) +
              parseInt(o ? o.borderBottomWidth : u.css('borderBottomWidth')),
            horiz:
              parseInt(o ? o.paddingLeft : u.css('paddingLeft')) +
              parseInt(o ? o.paddingRight : u.css('paddingRight')) +
              parseInt(o ? o.borderLeftWidth : u.css('borderLeftWidth')) +
              parseInt(o ? o.borderRightWidth : u.css('borderRightWidth'))
          },
          v = {
            vert:
              G.vert +
              parseInt(o ? o.marginTop : u.css('marginTop')) +
              parseInt(o ? o.marginBottom : u.css('marginBottom')) +
              2,
            horiz:
              G.horiz +
              parseInt(o ? o.marginLeft : u.css('marginLeft')) +
              parseInt(o ? o.marginRight : u.css('marginRight')) +
              2
          }
      ...
      setSize: function () {
        ...
        if (this.options.size === 'auto') {
          var q = function () {
            var R,
              ...
              O = Array.prototype.filter
                ? Array.prototype.filter.call(P, Q('d-none', false))
                : y.$lis.not('.d-none'),
              S = Array.prototype.filter
                ? Array.prototype.filter.call(O, Q('dropdown-header', true))
          ...
          this.$searchbox
            ...
            .on('input.getSize propertychange.getSize', q)
      ...
      togglePlaceholder: function () {
        ...
        this.$button.toggleClass(
          'bs-placeholder',
          n === null || n === '' || (n.constructor === Array && n.length === 0)
        )
      },
      tabIndex: function () {
        if (
                ...
                if ((I && r) || (z && u)) {
                  if (I && I == 1) {
                    ...
                    if (z && z == 1) {
                      ...
                      var p =
                          typeof n.options.maxOptionsText === 'string'
                            ? [n.options.maxOptionsText, n.options.maxOptionsText]
            ...
            if (p.length === q.length) {
              ...
              s.each(function (t) {
                ...
                if (u.hasClass('dropdown-divider')) {
                  ...
                  if (
                    u.hasClass('dropdown-header') &&
                    s.eq(t + 1).data('optgroup') !== u.data('optgroup')
                  ) {
                    u.addClass('d-none')
                  } else {
                    r = null
      ...
      keydown: function (x) {
        var y = g(this),
          ...
          q,
          z,
          p = ':not(.disabled, .d-none, .dropdown-header, .dropdown-divider)',
          r = {
            32: ' ',
            48: '0',
            49: '1',
        ...
        if (
          !z &&
          ((x.keyCode >= 48 && x.keyCode <= 57) ||
            (x.keyCode >= 96 && x.keyCode <= 105) ||
            (x.keyCode >= 65 && x.keyCode <= 90))
        ) {
        ...
        if (/(38|40)/.test(x.keyCode.toString(10))) {
          ...
          if (!y.is('input')) {
            ...
            w.each(function (B) {
              if (
                g
                  .trim(g(this).children('span.dropdown-item-inner').text().toLowerCase())
                  .substring(0, 1) == r[x.keyCode]
              ) {
                n.push(B)
              }
            })
        ...
        if (
          (/(13|32)/.test(x.keyCode.toString(10)) ||
            (/(^9$)/.test(x.keyCode.toString(10)) && u.options.selectOnTab)) &&
          z
        ) {
        ...
        if (
          (/(^9$|27)/.test(x.keyCode.toString(10)) && z && (u.multiple || u.options.liveSearch)) ||
          (/(27)/.test(x.keyCode.toString(10)) && !z)
        ) {
