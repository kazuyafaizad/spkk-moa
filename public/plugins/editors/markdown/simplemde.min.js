  ...
  })(
    {
      1: [
        function (e, t, n) {
          ...
          function l(e) {
            for (
              var t, n = e.length, r = n % 3, i = '', o = [], l = 16383, c = 0, u = n - r;
              u > c;
              c += l
            )
              ...
              for (var r = [], i = t; n > i; ) {
                ...
                if (n >= i + l) {
                  ...
                  switch (l) {
                    ...
                    case 2:
                      ;(s = e[i + 1]),
                        128 === (192 & s) && ((f = ((31 & o) << 6) | (63 & s)), f > 127 && (a = f))
                      break
                    case 3:
                      ;(s = e[i + 1]),
                        (c = e[i + 2]),
          ...
          !(function (i) {
            ...
            e.commands.newlineAndIndentContinueMarkdownList = function (i) {
              ...
              for (var o = i.listSelections(), a = [], l = 0; l < o.length; l++) {
                ...
                if (n.test(h))
                  i.replaceRange('', { line: s.line, ch: 0 }, { line: s.line, ch: s.ch + 1 }),
                    (a[l] = '\n')
                else {
                  var p = d[1],
                    m = d[5],
                    g =
                      r.test(d[2]) || d[2].indexOf('>') >= 0 ? d[2] : parseInt(d[3], 10) + 1 + d[4]
                  a[l] = '\n' + p + g + m
                }
              }
        ...
        function (t, n, r) {
          !(function (i) {
            ...
            function r(e, t, n, r) {
              if (0 != c(t, n))
                for (
                  var i = e.state.markedSelection, o = e.state.markedSelectionStyle, a = t.line;
                  ;
            ...
            function a(e) {
              ...
              c(n, u.to) > 0 &&
                (n.line - u.from.line < l ? (a.pop().clear(), r(e, u.from, n)) : r(e, u.to, n))
            }
          ...
          !(function (t) {
            ...
            function t(e, t, n) {
              ...
              ;(this.input = n),
                ...
                xo &&
                  8 > bo &&
                  ((r.gutters.style.zIndex = -1), (r.scroller.style.paddingRight = 0)),
              ...
              if (n && n.ensure) {
                ...
                o > l
                  ...
                  : Math.min(s, t.lastLine()) >= a &&
                    ((o = ni(t, ri(Zr(t, s)) - e.wrapper.clientHeight)), (a = s))
              }
            ...
            function k(e) {
              ...
              if (n.length != r.lineNumChars) {
                var i = r.measure.appendChild(
                    ji('div', [ji('div', n)], 'CodeMirror-linenumber CodeMirror-gutter-elt')
                  ),
            ...
            function N(e, t) {
              for (
                ...
                ((r && e.options.lineWrapping && t.oldDisplayWidth != $e(e)) ||
                  (n &&
                    null != n.top &&
                    (n = { top: Math.min(e.doc.height + qe(e.display) - Ve(e), n.top) }),
            ...
            function O(e) {
              for (var t = e.display, n = t.lineDiv.offsetTop, r = 0; r < t.view.length; r++) {
                ...
                if (!o.hidden) {
                  ...
                  if (
                    (2 > i && (i = yt(t)),
                    (s > 0.001 || -0.001 > s) && (ei(o.line, i), I(o.line), o.rest))
                  )
            ...
            function ce(e, t, n, r, i) {
              ...
              function a(t) {
                if (1 == t.nodeType) {
                  ...
                  if (null != n)
                    return '' == n && (n = t.textContent.replace(/\u200b/g, '')), void (l += n)
                  var u,
            ...
            function Me(e, t, n) {
              ;(Ni(e, 'beforeSelectionChange') || (e.cm && Ni(e.cm, 'beforeSelectionChange'))) &&
                (t = Ce(e, t, n))
                ...
                return (
                  eo(ii(f), n || 0, null == i ? h : i, function (e, t, a) {
                    ...
                    null == n && 0 == e && (d = c),
                      ...
                      (!s || f.bottom > s.bottom || (f.bottom == s.bottom && f.right > s.right)) &&
                        (s = f),
                      c + 1 > d && (d = c),
            ...
            function Fe(e) {
              var t = e.doc
              if (
                (t.frontier < t.first && (t.frontier = t.first), !(t.frontier >= e.display.viewTo))
              ) {
            ...
            function et(e, t) {
              ...
              r && !r.text
                ? (r = null)
                : r && r.changes && (D(e, r, n, P(e)), (e.curOp.forceUpdate = !0)),
                r || (r = Ze(e, t))
              var i = Xe(r, t, n)
              return {
                line: t,
            ...
            function rt(e, t, n, r) {
              ...
              if (3 == a.nodeType) {
                for (var u = 0; 4 > u; u++) {
                  ...
                  for (
                    ;
                    o.coverStart + s < o.coverEnd && zi(t.line.text.charAt(o.coverStart + s));
              ...
              if (xo && 9 > bo && !l && (!i || (!i.left && !i.right))) {
                ...
                i = h
                  ? { left: h.left, right: h.left + xt(e.display), top: h.top, bottom: h.bottom }
                  : qo
              }
              for (
            ...
            function ut(e, t, n, r) {
              ...
              var a = ri(t)
              if (
                ('local' == r ? (a += Ue(e.display)) : (a -= e.display.viewOffset),
                'page' == r || 'window' == r)
              ) {
            ...
            function vt(e, t, n, r, i) {
              function o(r) {
                ...
                return (
                  (l = !0), a > i.bottom ? i.left - s : a < i.top ? i.left + s : ((l = !1), i.left)
                )
              }
              var a = i - ri(t),
                l = !1,
              ...
              for (;;) {
                if (u ? d == h || d == fo(t, h, 1) : 1 >= d - h) {
                  for (
                    var y = p > r || g - r >= r - p ? h : d, x = r - (y == h ? p : g);
                    zi(t.text.charAt(y));
            ...
            function bt(e) {
              ;(e.curOp = {
                ...
                Go
                  ? Go.ops.push(e.curOp)
                  : (e.curOp.ownsGroup = Go = { ops: [e.curOp], delayedCallbacks: [] })
            }
            function wt(e) {
            ...
            function Dt(e, t, n, r) {
              ...
              s &&
                (n < s.lineN ? (s.lineN += r) : t < s.lineN + s.size && (i.externalMeasured = null))
            }
            function Ht(e, t, n) {
              e.curOp.viewChanged = !0
              var r = e.display,
            ...
            function Yt(e, t, n, r) {
              ...
              if (r && 1 == c.xRel && (s = Zr(e.doc, c.line).text).length == c.ch) {
                ...
                c = Bo(
                  c.line,
                  Math.max(0, Math.round((o - Ge(e.display).left) / xt(e.display)) - u)
                )
              }
              return c
            }
                ...
                if (r && !go && !Co && null != Ko)
                  return (
                    i &&
                      ...
                      rn(
                        e,
                        Math.max(0, Math.min(a.scrollTop + i * Ko, a.scrollHeight - a.clientHeight))
                      ),
                    on(
                      e,
                      Math.max(0, Math.min(a.scrollLeft + r * Ko, a.scrollWidth - a.clientWidth))
                    ),
                    (!i || (i && s)) && Ma(t),
                      ...
                      setTimeout(function () {
                        if (null != o.wheelStartX) {
                          var e = a.scrollLeft - o.wheelStartX,
                            ...
                            n =
                              (t && o.wheelDY && t / o.wheelDY) || (e && o.wheelDX && e / o.wheelDX)
            ...
            function mn(e) {
              var t = this
              if (
                !(Gt(t.display, e) || Ti(t, e) || (e.ctrlKey && !e.altKey) || (Eo && e.metaKey))
              ) {
                var n = e.keyCode,
                  r = e.charCode
            ...
            function Tn(e, t, n) {
              ...
              if (
                !(Ni(e, 'beforeChange') || (e.cm && Ni(e.cm, 'beforeChange'))) ||
                (t = Ln(e, t, !0))
              ) {
            ...
            function Mn(e, t) {
              if (1 != t.text.length || '' != t.text[0] || 0 != _o(t.from, t.to)) {
                ...
                var r = []
                Kr(e, function (e, n) {
                  n || -1 != Pi(r, e.history) || (xi(e.history, t), r.push(e.history)),
                    En(e, t, null, or(e, t))
                })
              }
            }
              ...
              if (!e.cm || !e.cm.state.suppressEdits) {
                ...
                if (s != a.length) {
                  ...
                  for (
                    ...
                    var h = s ? kn(e, f) : Ii(a)
                    En(e, f, h, lr(e, f)),
                      !s && e.cm && e.cm.scrollIntoView({ from: f.from, to: Qo(f) })
                    var d = []
                    Kr(e, function (e, t) {
                      t || -1 != Pi(d, e.history) || (xi(e.history, f), d.push(e.history)),
                        En(e, f, null, lr(e, f))
                    })
                  }
                }
            ...
            function Rn(e, t, n, r) {
              ...
              for (var i = 0; 5 > i; i++) {
                ...
                if (
                  (null != s.scrollTop &&
                    (rn(e, s.scrollTop), Math.abs(e.doc.scrollTop - c) > 1 && (o = !0)),
                  null != s.scrollLeft &&
                    (on(e, s.scrollLeft), Math.abs(e.doc.scrollLeft - u) > 1 && (o = !0)),
                  !o)
                )
                  break
              }
            ...
            function Hn(e, t, n, r, i) {
              ...
              0 > n && (n = 0)
              var l =
                  e.curOp && null != e.curOp.scrollTop ? e.curOp.scrollTop : o.scroller.scrollTop,
                s = Ve(e),
                c = {}
              i - n > s && (i = n + s)
            ...
            function Wn(e, t, n) {
              ;(null == t && null == n) || _n(e),
                null != t &&
                  (e.curOp.scrollLeft =
                    (null == e.curOp.scrollLeft ? e.doc.scrollLeft : e.curOp.scrollLeft) + t),
                null != n &&
                  (e.curOp.scrollTop =
                    (null == e.curOp.scrollTop ? e.doc.scrollTop : e.curOp.scrollTop) + n)
            }
            function Bn(e) {
              _n(e)
              var t = e.getCursor(),
                ...
                r = t
              e.options.lineWrapping ||
                ((n = t.ch ? Bo(t.line, t.ch - 1) : t), (r = Bo(t.line, t.ch + 1))),
                (e.curOp.scrollToPos = {
                  from: n,
                  to: r,
            ...
            function Fn(e, t, n, r) {
              ...
              if (r || /\S/.test(l.text)) {
                if (
                  'smart' == n &&
                  ((c = o.mode.indent(i, l.text.slice(u.length), l.text)), c == Ha || c > 150)
                ) {
                  if (!r) return
                  n = 'prev'
                }
            ...
            function Yn(e) {
              for (
                var t, n, r, i, o = e.split(/-(?!$)/), e = o[o.length - 1], a = 0;
                a < o.length - 1;
                a++
              ) {
                var l = o[a]
              ...
              if (e)
                for (var r, i = 0; i < e.length; ++i) {
                  ...
                  if (l || (o.from == t && 'bookmark' == a.type && (!n || o.marker.insertLeft))) {
                    ...
                    ;(r || (r = [])).push(
                      new Qn(a, s ? null : o.from - t, null == o.to ? null : o.to - t)
                    )
                  }
                }
              return r
                ...
                qr(a, r, Dr(e, a, l)),
                  a.styleClasses &&
                    ...
                    a.styleClasses.textClass &&
                      (r.textClass = $i(a.styleClasses.textClass, r.textClass || ''))),
                  0 == r.map.length &&
                    r.map.push(0, 0, r.content.appendChild(Zi(e.display.measure))),
                  0 == i
                  ...
                  if (v == p) {
                    ...
                    for (var y, x = [], b = 0; b < r.length; ++b) {
                      ...
                      'bookmark' == k.type && w.from == p && k.widgetNode
                        ? x.push(k)
                        : w.from <= p &&
                            (null == w.to || w.to > p || (k.collapsed && w.to == p && w.from == p))
                    ...
                    if (h && (h.from || 0) == p) {
                      if (
                        (Ur(t, (null == h.to ? d + 1 : h.to) - p, h.marker, null == h.from),
                        null == h.to)
                      )
                        return
                      h.to == p && (h = !1)
              ...
              for (var i = 0; i < e.length; ++i) {
                ...
                if (o.ranges) {
                  ...
                  for (var l = 0; l < o.changes.length; ++l) {
                    var s = o.changes[l]
                    if (n < s.from.line)
                      (s.from = Bo(s.from.line + r, s.from.ch)), (s.to = Bo(s.to.line + r, s.to.ch))
                    else if (t <= s.to.line) {
                      a = !1
                      break
                    }
            ...
            function Hi(e, t) {
              var n
              return (
                Object.create ? (n = Object.create(e)) : ((Di.prototype = e), (n = new Di())),
                t && Wi(t, n),
                n
              )
            }
              ...
              if (null == Ka) {
                ...
                qi(e, ji('span', [t, document.createTextNode('x')])),
                  0 != e.firstChild.offsetHeight &&
                    (Ka = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(xo && 8 > bo))
              }
              var n = Ka
                ? ji('span', '​')
            ...
            function eo(e, t, n, r) {
              ...
              for (var i = !1, o = 0; o < e.length; ++o) {
                ...
                ;((a.from < n && a.to > t) || (t == n && a.to == t)) &&
                  (r(Math.max(a.from, t), Math.min(a.to, n), 1 == a.level ? 'rtl' : 'ltr'),
                  (i = !0))
              }
              i || r(t, n, 'ltr')
            }
            ...
            ;(e.prototype = {
              ...
              setOption: function (e, t) {
                var n = this.options,
                  r = n[e]
                ;(n[e] == t && 'mode' != e) ||
                  ((n[e] = t), ta.hasOwnProperty(e) && Et(this, ta[e])(this, t, r))
              },
              ...
              heightAtLine: function (e, t) {
                ...
                if ('number' == typeof e) {
                  ...
                  e < this.doc.first ? (e = this.doc.first) : e > i && ((e = i), (r = !0)),
                    (n = Zr(this.doc, e))
                } else n = e
                return (
              ...
              findPosV: function (e, t, n, r) {
                ...
                for (var a = 0, l = me(this.doc, e); t > a; ++a) {
                  var s = dt(this, l, 'div')
                  if ((null == o ? (o = s.left) : (s.left = o), (l = qn(this, s, i, n)), l.hitSide))
                    break
                }
                return l
              },
            ...
            ;(e.defineMode = function (t, n) {
              ...
              (e.getMode = function (t, n) {
                ...
                if (oa.hasOwnProperty(n.name)) {
                  ...
                  for (var a in o)
                    o.hasOwnProperty(a) &&
                      (i.hasOwnProperty(a) && (i['_' + a] = i[a]), (i[a] = o[a]))
                }
            ...
            ;($r.prototype = {
              ...
              (Vr.prototype = {
                ...
                removeInner: function (e, t) {
                  ...
                  if (
                    this.size - t < 25 &&
                    (this.children.length > 1 || !(this.children[0] instanceof $r))
                  ) {
                    var l = []
                    this.collapse(l),
              ...
              removeLineClass: It(function (e, t, n) {
                return zn(this, e, 'gutter' == t ? 'gutter' : 'class', function (e) {
                  ...
                  if (null == n) e[r] = null
                    ...
                    e[r] =
                      i.slice(0, o.index) + (o.index && a != i.length ? ' ' : '') + i.slice(a) ||
                      null
                  }
                  return !0
                })
            ...
            var qa,
              ...
              Ya = (e.isWordChar = function (e) {
                return (
                  /\w/.test(e) || (e > '' && (e.toUpperCase() != e.toLowerCase() || Ga.test(e)))
                )
              }),
              $a =
                ...
                return function (n) {
                  ...
                  for (var h = 0; u > h; ++h) {
                    ...
                    if (',' == r) f[h] = 'N'
                      ...
                      for (
                        var g = (h && '!' == f[h - 1]) || (u > m && '1' == f[m]) ? '1' : 'N', v = h;
                        m > v;
                        ++v
                      )
                        f[v] = g
            ...
            e.defineMode(
              ...
              function (t, n) {
                ...
                function p(t, r) {
                  ...
                  if ('*' === s || ('_' === s && !C))
                    if (l && ' ' === t.peek());
                      ...
                      if (!r.strong && t.eat(s))
                        return (
                          (r.strong = s), n.highlightFormatting && (r.formatting = 'strong'), h(r)
                        )
                      if (r.em === s) {
                      ...
                      if (!r.em)
                        return (r.em = s), n.highlightFormatting && (r.formatting = 'em'), h(r)
                    }
                ...
                var L = /^([*\-_])(?:\s*\1){2,}\s*$/,
                  ...
                  I = new RegExp(
                    '^(' +
                      (n.fencedCodeBlocks === !0 ? '~~~+|```+' : n.fencedCodeBlocks) +
                      ')[ \\t]*([\\w+#-]*)'
                  ),
                  P = {
                    ')': /^(?:[^\\\(\)]|\\.|\((?:[^\\\(\)]|\\.)*\))*?(?=\))/,
            ...
            var i = function (e, t, n, i) {
              if (
                ...
                if (
                  ...
                  t ||
                    (t = this._readFile(
                      chrome.extension.getURL('lib/typo/dictionaries/' + e + '/' + e + '.aff')
                    )),
                    n ||
                      (n = this._readFile(
                        chrome.extension.getURL('lib/typo/dictionaries/' + e + '/' + e + '.dic')
                      ))
                else {
            ...
            ;(i.prototype = {
                      ...
                      ;(b.add = v),
                        ...
                        '.' !== x &&
                          ('SFX' === l
                            ...
                            : (b.match = new RegExp('^' + x))),
                        '0' != m &&
                          ('SFX' === l ? (b.remove = new RegExp(m + '$')) : (b.remove = m)),
                        f.push(b)
                    }
                          ...
                          if ((t(v, []), d.combineable))
                            for (var y = u + 1; f > y; y++) {
                              ...
                              if (b && b.combineable && d.type != b.type)
                                for (
                                  var w = this._applyRule(v, b), k = 0, S = w.length;
                                  S > k;
                                  k++
                                ) {
                                  var C = w[k]
              ...
              suggest: function (e, t) {
                ...
                function i(e) {
                  ...
                  for (
                    var o = n([e]), a = n(o), l = r(o).concat(r(a)), s = {}, u = 0, f = l.length;
                    f > u;
                    u++
                  )
      ...
      20: [
        function (e, t, n) {
          ...
          function h(e) {
            ...
            if ('single' === p) {
              ...
              if (u.line !== f.line || u.ch !== f.ch) (o = u.line), (a = f.line), 0 === f.ch && a--
                ...
                for (o = u.line; o >= 0; o--)
                  if (
                    ((d = c.getLineHandle(o)), !d.text.match(/^\s*$/) && 'indented' !== r(c, o, d))
                  ) {
                    o += 1
                    break
                  }
                for (l = c.lineCount(), a = u.line; l > a; a++)
                  if (
                    ((d = c.getLineHandle(a)), !d.text.match(/^\s*$/) && 'indented' !== r(c, a, d))
                  ) {
                    a -= 1
                    break
                  }
          ...
          function O(e, t, n) {
            if (!/editor-preview-active/.test(e.getWrapperElement().lastChild.className)) {
              for (
                var r = e.getCursor('start'), i = e.getCursor('end'), o = r.line;
                o <= i.line;
                o++
              )
                !(function (r) {
          ...
          function P(e, t, n, r) {
            if (
              !/editor-preview-active/.test(e.codemirror.getWrapperElement().lastChild.className)
            ) {
          ...
          function R(e) {
            if (!/editor-preview-active/.test(e.getWrapperElement().lastChild.className))
              for (
                var t, n = e.getCursor('start'), r = e.getCursor('end'), i = n.line;
                i <= r.line;
                i++
              )
                (t = e.getLine(i)),
          ...
          function B(e) {
            ...
            if ((e.autoDownloadFontAwesome === !1 && (t = !1), e.autoDownloadFontAwesome !== !0))
              for (var n = document.styleSheets, r = 0; r < n.length; r++)
                n[r].href &&
                  n[r].href.indexOf('//maxcdn.bootstrapcdn.com/font-awesome/') > -1 &&
                  (t = !1)
            if (t) {
