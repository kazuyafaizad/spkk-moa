;(function (e) {
  ...
  function z(a, b) {
    u === q &&
      (u = -1 === x.serializeToString(e.parseXML(A['xl/worksheets/sheet1.xml'])).indexOf('xmlns:r'))
      ...
      if (e.isPlainObject(c)) {
        ...
        if (u) {
          ...
          for (g = v.length; h < g; h++)
            (f = c.createAttribute(v[h].name.replace(':', '_dt_b_namespace_token_'))),
              (f.value = v[h].value),
      ...
      E = function (a, b, d) {
        ...
        if (K)
          ...
          e || (e = (f.URL || f.webkitURL || f).createObjectURL(a)),
            d ? (f.location.href = e) : f.open(e, '_blank') || (f.location.href = e),
            (c.readyState = c.DONE),
            h(),
            C(e)
      },
  ...
  p.ext.buttons.excelHtml5 = {
    ...
    action: function (a, b, d, c) {
          ...
          for (var b = 0, d = a.length; b < d; b++) {
            ...
            f ||
              ...
              (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                ? (f = o(g, 'c', { attr: { t: 'n', r: i }, children: [o(g, 'v', { text: a[b] })] }))
                : ((m = !a[b].replace
                    ? a[b]
                    : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, '')),
                  (f = o(g, 'c', {
                    attr: { t: 'inlineStr', r: i },
                    children: { row: o(g, 'is', { children: { row: o(g, 't', { text: m }) } }) }
                  }))))
            p.appendChild(f)
          }
          k.appendChild(p)
      ...
      for (n = d.header.length; j < n; j++)
        b.appendChild(
          o(g, 'col', { attr: { min: j + 1, max: j + 1, width: J(d, j), customWidth: 1 } })
        )
  ...
  p.ext.buttons.pdfHtml5 = {
    ...
    action: function (a, b, d, c) {
      ...
      b.messageTop &&
        a.content.unshift({ text: b.messageTop, style: 'message', margin: [0, 0, 0, 12] })
      b.messageBottom &&
        a.content.push({ text: b.messageBottom, style: 'message', margin: [0, 0, 0, 12] })
