...
;(function (d) {
      ...
      var c = [],
        ...
        h = function (a, b) {
          ...
          if (d.isArray(a) || a instanceof d) {
            ...
            'object' === typeof a &&
              a.nodeName &&
              ((i = d.inArray(a, f)), -1 !== i && c.push({ inst: b, node: f[i] }))
        },
        g = 0,
        f = a.length;
      g < f;
        ...
        f && 'absolute' === h
          ...
          : 'absolute' === h
            ? (e._collection.css({ top: a.top + c.outerHeight(), left: a.left }),
              ...
              (f = g.offset().top - f),
              c > f && e._collection.css('top', a.top - e._collection.outerHeight() - 5),
  ...
  i.Api.registerPlural('buttons().containers()', 'buttons().container()', function () {
    ...
    this.iterator(!0, 'table', function (c) {
      if (c._buttons)
        for (var c = m.instanceSelector(b, c._buttons), d = 0, h = c.length; d < h; d++)
  ...
  i.Api.register('button().add()', function (a, b) {
    var c = this.context
    c.length &&
      ((c = m.instanceSelector(this._groupSelector, c[0]._buttons)), c.length && c[0].add(b, a))
  ...
  i.Api.register('buttons.exportInfo()', function (a) {
    ...
    var c = a
    b =
      '*' === c.filename && '*' !== c.title && c.title !== l && null !== c.title && '' !== c.title
        ? c.title
        : c.filename
