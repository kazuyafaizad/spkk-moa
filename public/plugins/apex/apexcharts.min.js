        ...
        s(
          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                for (
                  var e = '', i = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz', s = 0;
                  s < t;
                  s++
                )
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  ...
                  I.attr('index', a),
                  y && I.attr({ 'clip-path': 'url(#gridRectMask'.concat(C.globals.cuid, ')') }),
                ...
                return (
                  !P || C.globals.resized || C.globals.dataChanged
                    ? (!C.globals.resized && C.globals.dataChanged) || z.showDelayedElements()
  ...
  var p = {
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (e = (e = (e = (e = (e = e.replace(new RegExp(o[0], 'g'), o[S])).replace(
                new RegExp(l[0], 'g'),
                l[S]
              )).replace(new RegExp(n[0], 'g'), n[u])).replace(
                new RegExp(r[0], 'g'),
                r[u]
              )).replace(/\\(.)/g, '$1'))
            }
          ...
          [
            {
              ...
              value: function (t) {
                ...
                var e = t.xaxis.labels.formatter,
                  i =
                    t.xaxis.categories && t.xaxis.categories.length ? t.xaxis.categories : t.labels
                return (
                  i &&
                    i.length &&
            ...
            value: function () {
              ...
              ;(this.chartType = e.chart.type),
                'histogram' === this.chartType &&
                  ((e.chart.type = 'bar'),
                  (e = d.extend({ plotOptions: { bar: { columnWidth: '99.99%' } } }, e))),
        ...
        s(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              if (
                (h.attr('clip-path', 'url(#gridRectMarkerMask'.concat(s.globals.cuid, ')')),
                ...
                for (var c = 0; c < r.x.length; c++) {
                  ...
                  if (
                    ((g = g || 0),
                    ((0 === x && 0 === b) || null === b || void 0 === s.globals.series[n][d]) &&
                      (u = !1),
                    u)
                  ) {
            ...
            value: function (t, e, i, s, a, n, r) {
              ...
              if (o.globals.dataChanged)
                if (this.dynamicAnim) {
                  ...
                  null != (z = o.globals.previousPaths[a] && o.globals.previousPaths[a][r]) &&
            ...
            value: function (t, e, i) {
              ...
              for (var d = 0; d < t.x.length; d++)
                if (
                  ...
                  'bottom' === s &&
                    (l = l + 2 * a.globals.markers.size[e] + 1.4 * parseInt(r.style.fontSize)),
                  !isNaN(o))
                ) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                if (
                  (g &&
                    (p = this.dataLabelsCorrection(s, a, o, n, r, d, parseInt(c.style.fontSize))),
                  ...
                  if (
                    (x.attr({ class: 'apexcharts-datalabel', cx: s, cy: a }), c.dropShadow.enabled)
                  ) {
                    var b = c.dropShadow
          ...
          },
          {
            ...
            value: function (t) {
              ...
              d.globals.isXNumeric &&
                (l = (d.globals.seriesX[g][p] - d.globals.minX) / this.invertedXRatio - i)
                  ...
                  x: (o =
                    void 0 === this.series[g][p] || null === this.series[g][p]
                      ...
                      : r +
                        ...
                        2 * (this.isReversed ? this.series[g][p] / this.invertedYRatio : 0)),
                  zeroW: r
                },
                  ...
                  y: (s =
                    void 0 === this.series[g][p] || null === this.series[g][p]
                      ...
                      : l -
                        ...
                        2 *
                          (this.isReversed ? this.series[g][p] / this.yRatio[this.yaxisIndex] : 0)),
                  zeroH: l
                },
                y = this.barEndingShape(d, v, this.series, g, p)
              if (
          ...
          },
          {
            ...
            value: function (t) {
              ...
              d.globals.isXNumeric &&
                ...
                ((p = e + parseFloat(l * (h + 1)) - g), (x = i + parseFloat(o * (h + 1)) - g))
              var b = e,
                m = i,
                v = {},
    ...
    I = (function () {
      function t(i) {
        ...
        var s = this.w
        ;(this.lineColorArr =
          void 0 !== s.globals.stroke.colors ? s.globals.stroke.colors : s.globals.colors),
          (this.defaultSize =
        ...
        s(t, [
          {
            ...
            value: function (t) {
              ...
              ;(this.size =
                this.defaultSize / 2.05 - e.config.stroke.width - e.config.chart.dropShadow.blur),
              ...
              for (var g = 0; g < t.length; g++) {
                ...
                var x = h - o,
                  ...
                  v = a.drawPath({
                    d: m,
                    stroke:
                      this.lineColorArr instanceof Array ? this.lineColorArr[g] : this.lineColorArr,
          ...
          },
          {
            ...
            value: function (t, e, i, s, a, n) {
              ...
              l.globals.dataChanged &&
                ...
                ((r = o.getPiePath({ me: o, startAngle: d, angle: a, size: h })), t.attr({ d: r })),
                0 !== n.dur
                  ? t
            ...
            value: function (t) {
              ...
              for (
                ...
                !Y.initialAnim ||
                  ...
                  this.animBeginArr.push(this.animDur)),
                  e.globals.dataChanged &&
                    ((F = ((z - k) / 360) * e.config.chart.animations.dynamicAnimation.speed),
                    (this.animDur = F / (1.2 * t.series.length) + this.animDur),
                    this.animBeginArr.push(this.animDur)),
                  Y.animatePaths(T, {
                    centerX: t.centerX,
        ...
        s(i, [
          {
            ...
            value: function (t, e) {
              ...
              ;(this.rangeBarOptions = this.w.config.plotOptions.rangeBar),
                ...
                this.initVariables(t)
              for (
                var n = s.group({ class: 'apexcharts-rangebar-series apexcharts-plot-series' }),
                  r = 0,
                  o = 0;
                r < t.length;
                r++, o++
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.indexes,
                ...
                p = o
              l.globals.isXNumeric &&
                (i = (l.globals.seriesX[c][d] - l.globals.minX) / this.invertedXRatio - r)
              ...
              return (
                (a =
                  h.move(g, x) + h.line(p, x) + h.line(p, x + r) + h.line(g, x + r) + h.line(g, x)),
        ...
        s(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              for (
                ...
                if (
                  'line' === o &&
                  ('gradient' === s.config.fill.type || 'gradient' === s.config.fill.type[v]) &&
                ...
                c.length > 1 && (this.yaxisIndex = A),
                  (this.isReversed =
                    s.config.yaxis[this.yaxisIndex] && s.config.yaxis[this.yaxisIndex].reversed)
                var L = [],
                  P = [],
                  M =
                    s.globals.gridHeight -
                ...
                for (
                  var $ =
                      s.globals.dataPoints > 1 ? s.globals.dataPoints - 1 : s.globals.dataPoints,
                    J = 0;
                  J < $;
                  J++
                ) {
                  ...
                  s.config.chart.stacked
                    ? ((U =
                        v > 0 && s.globals.collapsedSeries.length < s.config.series.length - 1
                          ? b[v - 1][J + 1]
                          : M),
                      (X =
                ...
                b.push(L),
                  ...
                  this.pointsChart || s.globals.delayedElements.push({ el: H.node, index: A })
                var rt = {
                  i: v,
                  realIndex: A,
                  animationDelay: v,
            ...
            value: function (t) {
              ...
              if (
                (Array.isArray(x.config.stroke.curve) &&
                  (m = Array.isArray(p) ? x.config.stroke.curve[p[i]] : x.config.stroke.curve[i]),
                'smooth' === m)
              ) {
                var v = 0.35 * (a - r)
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function (t, e, i, s) {
              ...
              return (
                0 === h[0] && (h[0] = 1), { result: h, niceMin: h[0], niceMax: h[h.length - 1] }
              )
            }
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                var r =
                  e.minX -
                  ((e.svgWidth / e.dataPoints) * (Math.abs(e.maxX - e.minX) / e.svgWidth)) / 2
              ...
              return (
                1 === t.globals.labels.length
                  ...
                  : t.globals.minXDiff === Number.MAX_VALUE &&
                    (t.globals.timelineLabels.length > 0 && (e = t.globals.timelineLabels.length),
                    e < 3 && (e = 3),
        ...
        s(t, [
                ...
                i.config.yaxis.forEach(function (a, n) {
                  ...
                  ;(!a.show ||
                    ...
                    ((!i.globals.isBarHorizontal &&
                      ...
                      (function (t) {
                        e.timescaleLabels
                          ? e.timescaleLabels[e.timescaleLabels.length - 1].position + t.width >
                            i.globals.gridWidth
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                1.05 *
                  (t = new f(this.ctx).getTextRects(s, e.config.xaxis.labels.style.fontSize))
                    .width *
                  i.length >
                  e.globals.gridWidth &&
        ...
        s(t, [
          {
            ...
            value: function () {
              ...
              ;(t.axisCharts =
                ...
                (t.xyCharts =
                  ['line', 'area', 'bar', 'rangeBar', 'candlestick', 'scatter', 'bubble'].indexOf(
                    i
                  ) > -1),
                (t.isBarHorizontal =
                  ('bar' === e.chart.type || 'rangeBar' === e.chart.type) &&
              ...
              for (var r = 0; r < t[e].data.length; r++)
                void 0 !== t[e].data[r].y &&
                  (Array.isArray(t[e].data[r].y)
                    ? this.twoDSeries.push(d.parseNumber(t[e].data[r].y[t[e].data[r].y.length - 1]))
                  ...
                  function (i) {
                    ...
                    var a = function () {
                      t.ctx._updateOptions(
                        {
                          chart: {
                            selection: { xaxis: { min: s.w.globals.minX, max: s.w.globals.maxX } }
                          }
                        },
                        !1,
                        !1
                    ...
                    for (var L = r, z = 0; z < L; z++) {
                      ...
                      if (t.config.grid.xaxis.lines.show) {
                        ...
                        M.node.classList.add('apexcharts-gridline'),
                          n.add(M),
                          this.animX && this.animateLine(M, { x1: 0, x2: 0 }, { x1: w, x2: y })
                      }
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              if (void 0 !== s.config.grid.row.colors && s.config.grid.row.colors.length > 0)
                for (
                  var n = 0, r = s.globals.gridHeight / i, o = s.globals.gridWidth, l = 0, h = 0;
                  l < i;
                  l++, h++
                ) {
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                for (
                  var s = t.globals.risingSeries.slice(), a = t.config.series.slice(), n = 0;
          ...
          },
          {
            ...
            value: function (t) {
              ...
              null === i
                ...
                : s.globals.isXNumeric
                  ? ((n = a[e][i]),
                    0 === a[e].length && (n = a[this.tooltipUtil.getFirstActiveXArray(a)][i]))
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              ;(l = d.x),
                (h = d.y),
                isNaN(l) ||
                  ((l += s.globals.translateX), (n.style.left = l + 'px'), (n.style.top = h + 'px'))
            }
          },
          {
            key: 'positionChecks',
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              l && (l.setAttribute('r', o), l.setAttribute('cx', i), l.setAttribute('cy', s)),
            ...
            value: function (t) {
              ...
              if (
                ...
                (l =
                  null !== h
                    ? h
                    : s.globals.dom.baseEl.querySelectorAll('.apexcharts-series-markers circle'))
              )
    ...
    (at = function (e, i) {
      ...
      ;(s.did = 1e3),
        ...
        s.extend(s.Array, {
          morph: function (t) {
            if (
              ((this.destination = this.parse(t)), this.value.length != this.destination.length)
            ) {
              for (
        ...
        (s.Doc = s.invent({
          ...
          extend: {
            ...
            spof: function () {
              ...
              return (
                t && this.style('left', (-t.e % 1) + 'px').style('top', (-t.f % 1) + 'px'), this
              )
            },
            remove: function () {
          ...
          extend: {
            ...
            plot: function (t, e, i, a) {
              return null == t
                ? this.array()
                : ((t =
                    void 0 !== e ? { x1: t, y1: e, x2: i, y2: a } : new s.PointArray(t).toLine()),
                  this.attr(t))
            },
            move: function (t, e) {
      ...
      ;['fill', 'stroke'].forEach(function (t) {
        ...
        s.extend(s.Element, s.FX, {
          ...
          flip: function (t, e) {
            return (
              (e = 'number' == typeof t ? t : e), this.transform({ flip: t || 'both', offset: e })
            )
          },
          matrix: function (t) {
            return this.attr(
          ...
          for (
            ...
            (t.requestAnimationFrame = t[s[a] + 'RequestAnimationFrame']),
              (t.cancelAnimationFrame =
                t[s[a] + 'CancelAnimationFrame'] || t[s[a] + 'CancelRequestAnimationFrame'])
    ...
    function () {
      ...
      ;(t.prototype.init = function (t, e) {
        ...
        (t.prototype.transformPoint = function (t, e) {
          ...
          return (
            (this.p.x = i.pageX - (e || 0)), (this.p.y = i.pageY), this.p.matrixTransform(this.m)
          )
        }),
          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                var e = this.w
                void 0 !== t.xaxis.min &&
                  ((e.config.xaxis.min = t.xaxis.min), (e.globals.lastXAxis.min = t.xaxis.min)),
                  void 0 !== t.xaxis.max &&
